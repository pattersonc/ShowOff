...
namespace ShowOff.Helpers
{
    public static class AppHelper
    {
        public static string UploadImageUrl(this HtmlHelper helper, string fileName)
        {
            return VirtualPathUtility.ToAbsolute("~/" + ItemImageRepository.RelativePath + fileName);
        }

        public static string ImageUrl(this HtmlHelper helper, string fileName)
        {
